...
@test vcov(x,y, multithreaded=true) ≈ vcov(x,y, multithreaded=false) ≈ vcov(x,y, multithreaded=:auto) ≈ cov(x,y)
@test vcov(x,y, corrected=false, multithreaded=true) ≈ vcov(x,y, corrected=false, multithreaded=false) ≈ cov(x,y, corrected=false)
@test vcor(x,y, multithreaded=true) ≈ vcor(x,y, multithreaded=false) ≈ vcor(x,y, multithreaded=:auto) ≈ cor(x,y)


# Test correlation and covariance functions as applied to matrices
X = rand(100,10)

@test vcov(X, multithreaded=true) ≈ vcov(X, multithreaded=false) ≈ vcov(X, multithreaded=:auto) ≈ cov(X)
...
@test vcor(X, multithreaded=true) ≈ vcor(X, multithreaded=false) ≈ vcor(X, multithreaded=:auto) ≈ cor(X)
